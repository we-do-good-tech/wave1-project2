...
router.post('/create-report', verifyToken, authSeets, findReport, teacherController.createReport)
...
router.post('/resend/parent-sign', verifyToken, authSeets, findReport, teacherController.resendParentSign)
